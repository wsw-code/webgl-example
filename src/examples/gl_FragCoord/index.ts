...
export default function() {
  ...
  function initBuffer() {
       ...
       let uniformTexture = webgl.getUniformLocation(program, "texture");
        ...
        let canvasWidth = webgl.getUniformLocation(program, "canvasWidth");

        let canvasHeight = webgl.getUniformLocation(program, "canvasHeight");

        webgl.uniform1f(canvasWidth, 500.0);
        webgl.uniform1f(canvasHeight, 500.0);
  }
  ...
  // function handleLoadedTexture(texture:WebGLTexture,image:WebGLTexture ) {
