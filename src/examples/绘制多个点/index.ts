...
export default function() {
  ...
  function initBuffer() {
      ...
      let arr = [
        ...
        200.0,200.0,0, 0.1, 1.0, 0.0,
        300.0,200.0,0, 1.0, 0.6, 0.5,
        300.0,300.0,0, 1.0, 0.0, 1.0
      ];
      ...
      webgl.vertexAttribPointer(aPosition,3, webgl.FLOAT, false, 6*4, 0);
      ...
      webgl.vertexAttribPointer(aColor,3, webgl.FLOAT, false, 6*4, 3*4);
