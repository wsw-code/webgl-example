 ...
 function render(img:HTMLImageElement[]) {
  ...
  function initBuffer() {
       ...
       if(!program) {
        ...
        handleLoadedTexture(texture0,img[0])
        // webgl.bindTexture(webgl.TEXTURE_2D, texture0);
        // webgl.texParameteri(webgl.TEXTURE_2D, webgl.TEXTURE_WRAP_S, webgl.CLAMP_TO_EDGE);
        // webgl.texParameteri(webgl.TEXTURE_2D, webgl.TEXTURE_WRAP_T, webgl.CLAMP_TO_EDGE);
        // webgl.texParameteri(webgl.TEXTURE_2D, webgl.TEXTURE_MIN_FILTER, webgl.NEAREST);
        // webgl.texParameteri(webgl.TEXTURE_2D, webgl.TEXTURE_MAG_FILTER, webgl.LINEAR);
        // webgl.texImage2D(webgl.TEXTURE_2D, 0, webgl.RGBA, webgl.RGBA, webgl.UNSIGNED_BYTE, img[0]);
        ...
        webgl.bindBuffer(webgl.ARRAY_BUFFER, vertexBuffer);
        webgl.vertexAttribPointer(uvAttributeLocation, 2, webgl.FLOAT, false, 16, 8);
        ...
        webgl.bindBuffer(webgl.ARRAY_BUFFER, vertexBuffer);
        webgl.vertexAttribPointer(positionAttributeLocation ,2, webgl.FLOAT, false, 16, 0);
...
const init = () => {
  ...
  Promise.all<HTMLImageElement>([initTexture(Logo)])
  .then((res)=>{
    render(res)
  })
